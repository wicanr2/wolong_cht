...
| [`docs/formats/07-battle.md`](formats/07-battle.md) | 07 — BATTLE. 戰場資料 | 分段結構、圖塊定義、子圖塊與人物圖形的像素格式都 confirmed。 | 2026-08-07 |
...
| [`docs/playtest/63-manual-coverage.md`](playtest/63-manual-coverage.md) | 63 — 說明書 11 章逐章盤點：哪些對過原版、用什麼方式對的 | 盤點，不是量測。 | 2026-09-04 |
| [`docs/playtest/64-appimage-20260904-reverify.md`](playtest/64-appimage-20260904-reverify.md) | 64 — 2026-09-04 的 AppImage 複驗：四個關卡對原版 0 px | 通過。 | 2026-09-04 |
...
| [`docs/playtest/78-ai-decision-trace.md`](playtest/78-ai-decision-trace.md) | 78 — AI 決策軌跡：原版與 remake 的事件產生形狀一致 | 通過（第一輪）。 | 2026-09-06 |
| [`docs/playtest/79-march-menu-original-layout.md`](playtest/79-march-menu-original-layout.md) | 79 — 行軍三選一的版面接回原版：三塊都逐像素 0 px | 通過。 | 2026-09-06 |
| [`docs/playtest/80-retreat-countdown.md`](playtest/80-retreat-countdown.md) | 80 — 退卻的 120 拍倒數：一拍減一次，而且正常打完根本用不到它 | 通過。 | 2026-09-06 |
...
| [`docs/playtest/96-map-click.md`](playtest/96-map-click.md) | 96 — 大地圖點擊接上：兩項選單 112×48 逐像素 0 px | 通過（框與內容）／受限（整張畫面）。 | 2026-09-06 |
...
| [`docs/re/88-mouse-cursor-visibility.md`](re/88-mouse-cursor-visibility.md) | 88 — 游標畫不畫由 byte_20100 一個 byte 決定，不是由畫面狀態 | confirmed。 | 2026-09-07 |
...
| [`docs/spec/122-sound-type-levels.md`](spec/122-sound-type-levels.md) | 122 — 音效的 TYPE 1–4：四段主衰減 | CONFORMED。 | 2026-09-03 |
...
| [`docs/spec/128-squad-leader-gone-keeps-reserve.md`](spec/128-squad-leader-gone-keeps-reserve.md) | 128 — 隊長倒下不會清掉那一隊的待機兵 | CONFORMED。 | 2026-09-03 |
| [`docs/spec/129-post-battle-morale-scaling.md`](spec/129-post-battle-morale-scaling.md) | 129 — 戰術戰鬥打完，兩側的士氣都要按兵力比縮 | CONFORMED。 | 2026-09-03 |
...
| [`docs/spec/134-pathfind-wave-order.md`](spec/134-pathfind-wave-order.md) | 134 — 尋路是波數佇列，不是先進先出：成本高的格子要等波數追上才展開 | CONFORMED。 | 2026-09-05 |
...
| [`docs/spec/139-ai-decision-trace.md`](spec/139-ai-decision-trace.md) | 139 — AI 決策軌跡對拍：攔事件產生器，比「誰在什麼時候決定了什麼」 | CONFORMED。 | 2026-09-06 |
...
| [`docs/spec/143-general-duty-field.md`](spec/143-general-duty-field.md) | 143 — 武將記錄 +0x17 是職務值，不是布林 | CONFORMED。 | 2026-09-06 |
...
| [`docs/spec/164-relief-request-gates.md`](spec/164-relief-request-gates.md) | 164 — 求援的三道閘：sub_14028 / sub_140C9 / sub_140B3 | CONFORMED。 | 2026-09-09 |
| [`docs/spec/165-growth-bounds-are-on-stored-value.md`](spec/165-growth-bounds-are-on-stored-value.md) | 165 — 上昇值的上下限套在存值上，不是實際值 | CONFORMED。 | 2026-09-09 |
| [`docs/spec/166-save-writeback-keeps-unmodelled-bits.md`](spec/166-save-writeback-keeps-unmodelled-bits.md) | 166 — 存檔寫回：軍團旗標的未解位元與據點游標 | CONFORMED。 | 2026-09-09 |
| [`docs/spec/167-day-is-23-hours.md`](spec/167-day-is-23-hours.md) | 167 — 一個遊戲日是 23 小時 ＝ 207 子刻，時從 1 走到 23 | CONFORMED。 | 2026-09-09 |
| [`docs/spec/168-corps-and-hour-cursors.md`](spec/168-corps-and-hour-cursors.md) | 168 — 另外兩個巡迴游標：軍團 +0x28、每「時」勢力 +0x2C | CONFORMED。 | 2026-09-09 |
...
| [`docs/spec/176-event-queue-cursor-not-restored.md`](spec/176-event-queue-cursor-not-restored.md) | 176 — 事件佇列游標要從存檔還原（區塊 +0x30） | CONFORMED。 | 2026-09-10 |
| [`docs/spec/177-replan-on-leg-not-from-city.md`](spec/177-replan-on-leg-not-from-city.md) | 177 — 走在路段上重新選路只在這條邊上決定方向 | CONFORMED。 | 2026-09-10 |
| [`docs/spec/178-upkeep-and-morale-gate-is-on-leg.md`](spec/178-upkeep-and-morale-gate-is-on-leg.md) | 178 — 軍費與士氣的判準是「有沒有走在路段上」 | CONFORMED。 | 2026-09-10 |
| [`docs/spec/179-recalc-on-battle-and-arrival-test.md`](spec/179-recalc-on-battle-and-arrival-test.md) | 179 — 戰後重算把移動計時寫 1；「到了沒」比的是節點欄不是 Corps.Node | CONFORMED。 | 2026-09-10 |
...
| [`docs/spec/184-relief-dispatch-want-is-always-one.md`](spec/184-relief-dispatch-want-is-always-one.md) | 184 — 求援調兵的 want 恆為 1 | CONFORMED。 | 2026-09-10 |
| [`docs/spec/185-monthly-settlement-call-order.md`](spec/185-monthly-settlement-call-order.md) | 185 — 月結內部的呼叫順序：政略在災害之前 | CONFORMED。 | 2026-09-10 |
| [`docs/spec/186-standoff-corps-before-city.md`](spec/186-standoff-corps-before-city.md) | 186 — 擋路判定的順序：先問軍團，再問據點 | CONFORMED。 | 2026-09-10 |
...
| [`docs/spec/200-opening-move-delay.md`](spec/200-opening-move-delay.md) | 200 — 開場的兵晚一拍才走 | DRAFT。 | 2026-09-11 |
