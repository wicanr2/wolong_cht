...
| [`docs/spec/164-relief-request-gates.md`](spec/164-relief-request-gates.md) | 164 — 求援的三道閘：sub_14028 / sub_140C9 / sub_140B3 | READY | 2026-09-09 |
| [`docs/spec/165-growth-bounds-are-on-stored-value.md`](spec/165-growth-bounds-are-on-stored-value.md) | 165 — 上昇值的上下限套在存值上，不是實際值 | READY | 2026-09-09 |
...
| [`docs/spec/170-ai-target-takes-two-ticks.md`](spec/170-ai-target-takes-two-ticks.md) | 170 — AI 挑到新目標要兩拍才會出發：+0x20 是意圖、+0x14 是行軍目標 | READY | 2026-09-09 |
...
| 鍵 | 出處 |
|---|---|
| 索引 ▸ AI 挑到新目標要兩拍才出發（+0x20 意圖／+0x14 行軍目標） | `docs/spec/00-index.md` |
...
| 索引 ▸ 求援的三道閘（立刻求援的條件、求援記錄、冷卻寫入） | `docs/spec/00-index.md` |
| 索引 ▸ 軍團與每「時」勢力的巡迴游標也要從存檔還原 | `docs/spec/00-index.md` |
