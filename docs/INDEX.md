...
| [`docs/playtest/49-parity-retest-20260827.md`](playtest/49-parity-retest-20260827.md) | 49 — 把記錄過的對拍全部重跑一次：兩組重現、一組失效 | 主畫面與野戰逐像素重現；系統選單與攻城的取樣點已經不等價。 ⭐ 攻城的 field 從記錄的 0.17% 變成 4.… | 2026-08-27 |
...
| [`docs/re/43-open-questions.md`](re/43-open-questions.md) | 43 — 未解缺口總表（生成的） | 生成的清單，跑 tools/py.sh tools/re_open_questions.py 重出。 這一份不下結論… | 2026-08-27 |
