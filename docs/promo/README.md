...
輸出（2026-08-26 第二版）：72.000 秒、1280×720、h264／aac 44.1 kHz 立體聲，
SHA-256 `f17e242e6ac718e6e2545d02d8b56c635ff331a451d5ef7e2351312fb91b6d4d`。

⚠ **第一版的動態段是在修「小兵只畫一半」與「月結框不消失」之前錄的**
（[`../spec/88`](../spec/88-display-polish-parity.md)），所以片子裡看得到那兩個問題。
**程式改了就要重錄動態段**，不能只重剪。
