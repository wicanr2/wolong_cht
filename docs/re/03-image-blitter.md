...
- `ICONGRF` **段 1 `0x0000` 那一塊畫了什麼**。
  尺寸與貼點已解——`0x0000` 是 128×32 貼在 (496, 248)、`0x0800` 是對方的將旗、
  `0x1000` 是自己的將旗、`0x1800` 是 128×96 的單欄六列面板
  （[`60`](60-tactical-sidebar.md) §2／§4／§6）。**剩下的是各塊的 UI 語意**，
  尤其 `0x0000` 那一塊（[`../formats/03`](../formats/03-grf-images.md) §5.3）。
  （`KYOGRF` 15 張 96×96、`IVENTGRF` 3 張 288×176 都已 confirmed，
  見 [`../formats/03`](../formats/03-grf-images.md) §3／§4。）
- `sub_1F4A2`（開檔／讀檔／關檔）的完整介面。
  （`sub_1E38C` 的介面已解，見 [`50`](50-city-info-window.md) §3.1。）
