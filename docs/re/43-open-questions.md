...
| [`playtest/119-rng-pace-comparison.md`](../playtest/119-rng-pace-comparison.md) | 全程 | 據點 106 的 `+0x15`（原版 06、remake 00）。寫入端只有 `sub_1237E`（暴風雨）與 `sub_134B1`，**欄位語意未解**，`docs/formats/08` 沒有它 | 靜態 |
