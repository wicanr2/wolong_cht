...
| [`spec/184-relief-dispatch-want-is-always-one.md`](../spec/184-relief-dispatch-want-is-always-one.md) | 拍 3,566：原版取了 `sub_14057` 的挑目標亂數而 remake 沒有 | （未解小節內文） | 靜態 |
