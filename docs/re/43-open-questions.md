...
| [`spec/183-occupancy-map-is-incremental.md`](../spec/183-occupancy-map-is-incremental.md) | 快照要帶佔用圖**（§3）。 | （未解小節內文） | 靜態 |
| [`spec/183-occupancy-map-is-incremental.md`](../spec/183-occupancy-map-is-incremental.md) | 原版的圖為什麼會「漂」（那一格少一支）還沒查。 | （未解小節內文） | 靜態 |
