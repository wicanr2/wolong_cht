...
| 3 | `0x9700` | `0x23A0` (9,120) | `sub_1006B` | **視窗外框 ＋ 數字字模 ＋ 視窗底紋**，走 `sub_1F888`（**位元對齊**的繪製常式，可放在非 8 倍數的 x）。`sub_100DF` 開機把它切成五塊（[`../spec/52`](../spec/52-main-screen-camera-and-banner-date.md) §4），外框那三種圖塊見 §5.4 ✅ |
