...
| 軍團 `+0x00` 位元 0、`+0x08`／`+0x09` 與 AI 編成的初值 | [`173-corps-flag-bit0-and-sprite-fields.md`](173-corps-flag-bit0-and-sprite-fields.md) | CONFORMED；軍團表四個檢查點逐 byte 相同 |
| 求援調兵只調站著的軍團，而且只寫意圖 | [`174-relief-dispatch-does-not-move-marching-corps.md`](174-relief-dispatch-does-not-move-marching-corps.md) | CONFORMED；AI 軍團走八格被彈回起點的根因 |
| 撞上敵人先對峙 12 個週期（96 拍）才開打 | [`175-encounter-standoff-countdown.md`](175-encounter-standoff-countdown.md) | CONFORMED；對拍量到 96 拍，戰鬥時機從早 94 拍變成晚 2 拍 |
...
| 佔用圖是增量維護的，據點 `+0x18` 從它抄 | [`183-occupancy-map-is-incremental.md`](183-occupancy-map-is-incremental.md) | CONFORMED；五個維護點全部照抄 |
| 求援調兵的 `want` 恆為 1 | [`184-relief-dispatch-want-is-always-one.md`](184-relief-dispatch-want-is-always-one.md) | CONFORMED；二十二個檢查點四張表全 0 |
...
| 鄰接遮罩是易主時的快照 | [`190-adjacency-mask-is-a-capture-time-snapshot.md`](190-adjacency-mask-is-a-capture-time-snapshot.md) | CONFORMED；5/17 的據點表由 5 個 byte／3 座歸零 |
...
| 野戰開打前要先擲戰場骰 | [`196-field-battle-rolls-the-battlefield.md`](196-field-battle-rolls-the-battlefield.md) | CONFORMED；順帶推翻「五格取樣是本格加下方一片」，五格是**十字** |
...
| 開場的兵晚一拍才走 | [`200-opening-move-delay.md`](200-opening-move-delay.md) | CONFORMED；接上之後逐拍 96 槽相同到拍 3，攻城縮圖 264 → 120 |
