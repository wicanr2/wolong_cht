...
拍 3,566 那個分歧已經解掉了：`Targets` 是空的，根因不在求援也不在
鄰居歸屬，而是**月結內部的呼叫順序**——政略評估在原版排在災害之前，
remake 排在之後，於是 5/1 月結那一拍的 647 次亂數次數相同而值全部錯位，
勢力 0 的宣戰沒排進事件游標取得到的槽（[`185`](185-monthly-settlement-call-order.md)）。
