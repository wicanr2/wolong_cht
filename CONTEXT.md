...
**下一項：`sub_15358` 尾段那八支批次呼叫。**

理由：資金／募兵／赤字懲罰已經解完並實作了，但**生產力的複利成長、
上昇值、防災值、三種災害的觸發**都還沒有公式——它們就在那八支裡
（`sub_15695`、`sub_1585F`、`sub_155A6`、`sub_12BD9`、`sub_15715`、
`sub_1578F`、`sub_122DB`、`sub_12286`）。
解完 `internal/rules/economy` 才算完整。**不需要 oracle。**
